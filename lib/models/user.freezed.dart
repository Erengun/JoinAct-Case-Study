...
class _$_LoginResponse implements _LoginResponse {
  const _$_LoginResponse({required this.token, required this.user});
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final UserModel user}) = _$_LoginResponse;
...
abstract class _UserModel extends UserModel {
  factory _UserModel(
      ...
      @HiveField(4) required final bool verified}) = _$_UserModel;
...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String surname, String mail, String phone});
}
...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, surname: $surname, mail: $mail, phone: $phone)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, surname, mail, phone);
